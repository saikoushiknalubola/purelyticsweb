        ...
        >
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center px-4 sm:px-0">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center h-12 sm:h-[52px] px-8 sm:min-w-[180px] rounded-full btn-primary text-base font-semibold"
            >
              Get Early Access
