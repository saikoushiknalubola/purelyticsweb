import { AlertTriangle, FlaskConical, Leaf, ShieldAlert, Beaker, Droplet } from "lucide-react";
...
const facts = [
  ...
  { icon: Droplet, text: "Titanium dioxide, banned as a food additive in the EU since 2022, still appears in candies and coatings sold elsewhere." },
