        ...
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 h-12 sm:h-13 px-8 min-w-[180px] rounded-full text-base font-bold transition-all group bg-accent text-accent-foreground"
            >
              Get Early Access
            ...
            <a 
              href="#how-it-works" 
              className="w-full sm:w-auto inline-flex items-center justify-center h-12 sm:h-13 px-8 min-w-[180px] rounded-full text-base font-semibold bg-background/10 border border-white/18 text-primary-foreground"
            >
              Learn More
            </a>
          </div>
